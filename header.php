...
<div class="login">
  ...
  <div class="dropdown-content">
    <a href="register_teacher.php">I'm a therapist</a>
    <a href="register.php">I'm a patient</a>
  </div>
</div>
<a href="http://localhost/pr3/index.php"><li>fourm</li></a>
	...
	<div class="header">
		<div class="container">
			<div class="header-main">
				<div class="logo">
			       <h1><span class="books"></span> <a href="index.php">I~communicate </a></h1>
						  ...
						  <li>
						  	<div class="banner-main">
								   <h3>ONLINE SPEECH THERAPY</h3>
						            <p>speech, language and communication therapy information,activities and products for children and adults</p>
								<div class="clearfix"> </div>
							</div>
						  </li>
<!--\
