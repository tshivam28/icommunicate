                ...
                <div class="modal-body">
                  <?php
                    if ($book_row['doc'] == 1) {
                      ...
                      <a href="<?php echo $book_row['link']?>" target="_blank"><button style="" class="btn btn-info btn-lg">Download file</button></a>
                      <?php
                    }elseif ($book_row['doc'] == 2) {
                      # code...
                      ?>
                      <p>We have Attached an Explaination PDF file for you to explain more.</p>
                      <a href="<?php echo $book_row['link']?>" target="_blank"><button style="" class="btn btn-info btn-lg">Download filet</button></a>
                      <?php
                    }
                  ?>
                </div>
