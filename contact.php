	...
	<div class="container">
		<div class="contact-main">
			<div class="contact-top">
				<h2>Contact</h2>
				<p> You are free to contact me through the following social media platforms.</p>
			</div>
			<div class="contact-block1">
			 	...
			 	<ul>
			    	...
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>8604563049</p></li>
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:tshivam057@gmail.com">tshivam057@gmail.com</a></p></li>
			    </ul>
			 	</div>
